...
public final class JsonUtils {
    ...
    public static <T> Set<T> parseFromJsonSet(String content, Class<T> genericType) throws IOException {
        return MAPPER.readValue(content, MAPPER.getTypeFactory().constructCollectionType(Set.class, genericType));
    }
